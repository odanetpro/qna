...
module ApplicationHelper
  ...
  def svg_icon_best_answer
    '<svg aria-hidden="true" class="svg-icon iconCheckmarkLg" width="36" height="36" viewBox="0 0 36 36" fill="rgba(47, 111, 68)">
